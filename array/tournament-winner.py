...
def tournamentWinner(competitions, results):
    ...
    # we will use the if statement to check if the current result is equal to 1
    ...
    # we will also use the if statement to check if the current team has more points than the current best team
    # if it does, we will update the current best team
    # we will also use the if statement to check if the current team has the same points as the current best team
...
# we will use the if statement to check if the current team is not in the scores dictionary
